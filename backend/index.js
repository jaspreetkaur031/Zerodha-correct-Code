...
// --- Middleware ---
app.use(cors());
// Use the built-in express.json() instead of bodyParser
...
app.post('/newOrder', async (req, res) => {
  try {
    ...
    // Wait for the order to actually save
    await newOrder.save(); 
...
// --- Start Server ---
// This new function connects to DB *first*, then starts the server.
const startServer = async () => {
  try {
    ...
    // 2. Start the Express server *after* DB is connected
    app.listen(PORT, () => {
