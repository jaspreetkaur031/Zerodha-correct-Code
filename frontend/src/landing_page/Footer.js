...
function Footer() {
    return ( 
        <div className='container-fluid footer-main-container'>
            <div className='container footer-2container'>
                <div className='row mb-5 pe-4 pb-1 footer-3container'>
                <div className='col me-5'>
                    <Link to='/'>
                    <img src='mediaimages\logo.svg' className='footer-logo' />
                    </Link>
                    <p className='footer-left-text'>&copy; 2010 - 2025, Zerodha Broking Ltd. All rights reserved.</p>
                ...
                <div className='col'>
                    <p className='footer-links-heading'>Support</p>
                    <div className='footer-links-a'>
            ...
            <div className='container footer-bottom-para'>
